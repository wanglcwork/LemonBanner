...
import com.lemon.pear.banner.moducle.main.view.CanItemDecoration;
 ...
 */
public class CanHeaderFooter extends FrameLayout {
    ...
    public CanHeaderFooter(Context context) {
        super(context);
    }

    public CanHeaderFooter(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CanHeaderFooter(Context context, AttributeSet attrs, int defStyleAttr) {
